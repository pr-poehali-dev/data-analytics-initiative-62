            ...
            >
              <div className="space-y-4">
                ...
                <p className="max-w-lg text-base text-white/60 leading-relaxed pt-2">
                  Профессиональная строительно-техническая и стоимостная оценка объектов недвижимости для судебных разбирательств. Разработка строительных проектов и дизайна помещений.
                </p>
